...
local base_highlight = require "themes.tomorrow.base_highlight"
...
M.set_theme = function(theme, colors)
  ...
  util.bg("NormalFloat", colors.ui)
  util.bg("CursorLine", colors.bg_accent1)
  util.fg("StatusLineNC", "none" .. " gui=none")
  util.fg("LineNr", colors.bg_accent4)
  util.fg("CursorLineNr", colors.fg)
  util.fg("NvimInternalError", colors.red)
  util.fg("VertSplit", colors.ui)

  -- Pmenu
  util.fg_bg("Pmenu", colors.bg_accent6, colors.bg_accent1)
  util.bg("PmenuSbar", colors.ui)
  util.bg("PmenuSel", colors.bg_accent5)
  util.bg("PmenuThumb", colors.blue)
  ...
  -- cmp
  util.fg("CmpItemAbbr", colors.bg_accent6)
  util.fg("CmpItemAbbrMatch", colors.red)
  util.fg("CmpItemKind", colors.orange)
  util.fg("CmpItemMenu", colors.blue)

  -- Git Signs
  util.fg_bg("DiffAdd", colors.green, "none")
  util.fg_bg("DiffChange", colors.bg_accent3, "none")
  util.fg_bg("DiffModified", colors.blue, "none")
  util.fg_bg("DiffRemoved", colors.red, "none")
  util.fg_bg("DiffDelete", colors.red, "none")

  --  Indent blankline
  util.fg("IndentBlanklineChar", colors.line)
  ...
  util.fg("NvimTreeIndentMarker", colors.bg_accent6)
  ...
  -- [[ Telescope
  util.fg("TelescopeBorder", colors.bg_accent4)
  util.fg_bg("TelescopePreviewTitle", colors.green, colors.bg_accent2)
  util.fg_bg("TelescopePromptTitle", colors.blue, colors.bg_accent2)
  util.fg_bg("TelescopeResultsTitle", colors.red, colors.bg_accent2)
  -- ]]
